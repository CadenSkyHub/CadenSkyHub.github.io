...
- [python 标准库](https://docs.python.org/zh-cn/3/library/index.html)
  - [文本处理服务](https://docs.python.org/zh-cn/3/library/text.html)
    - [字符串操作](https://docs.python.org/zh-cn/3/library/string.html#module-string)
  - [数据类型](https://docs.python.org/zh-cn/3/library/datatypes.html)
    - [日期和时间](https://docs.python.org/zh-cn/3/library/datetime.html)
    - [拷贝](https://docs.python.org/zh-cn/3/library/copy.html)
    - [枚举](https://docs.python.org/zh-cn/3/library/enum.html)
  - [数字和数学模块](https://docs.python.org/zh-cn/3/library/numeric.html)
    - [math数学模块](https://docs.python.org/zh-cn/3/library/math.html)
    - [random 伪随机数](https://docs.python.org/zh-cn/3/library/random.html)
  - [文件和目录访问](https://docs.python.org/zh-cn/3/library/filesys.html)
      - [常用的路径操作](https://docs.python.org/zh-cn/3/library/os.path.html)
  - [通用操作系统服务](https://docs.python.org/zh-cn/3/library/allos.html)
      - [多种操作系统接口](https://docs.python.org/zh-cn/3/library/os.html)
  ...
  - [网络和进程间通信](https://docs.python.org/zh-cn/3/library/ipc.html)
      ...
      - [`socket` - 低层级的网络接口](https://docs.python.org/zh-cn/3/library/socket.html)
